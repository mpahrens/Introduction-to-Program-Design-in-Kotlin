...
fun boxLabelArea(width: Double, height: Double): Double {
    ...
    },
    {
      ...
      title: "Choices and Compound Data",
      minutes: 13,
      summary: "Five necessary readings introduce fixed choices, case analysis, and values that carry several fields. Optional readings explore structural equality, named arguments, data-class copy, and Compound data in wider computing.",
      cardSummary: "Short readings on enums, exhaustive when expressions, data classes, fields, named arguments, copy, and Compound data.",
...
val semesterStart: Season = Season.FALL`,
    ...
    return when (season) {
        ...
        R(
          ...
          "Define a Compound-data type with a Kotlin data class.",
          ["data-class", "field", "constructor"],
          "Compound types combine several fields into one value. Kotlin Compound types are made using a <strong>data class</strong> consisting of a type/constructor name and where each field has a name and type. Together, the fields describe all the information needed for one object value.",
          "This is compound data: making one value requires a value for every field. Grouping related fields prevents long collections of unrelated local names.",
          `data class Book(
    val title: String,
    val pages: Int,
    val format: String
        ...
        R(
          ...
          "Construction puts information together. Field selection takes one piece back out. These are the basic producer and consumer operations for compound data.",
...
val expanded = original.copy(pages = 96)`,
        ...
        R(
          ...
          "Why this matters: Compound Data in Computer Science",
          "optional",
          "Later computer science courses use compound data to represent records, database rows, messages, and measurements: several facts about one thing that must stay together.",
          "Identify a situation where a record shape makes it easier to move, store, or compare related information.",
          ["compound-data", "record", "field"],
...
val city = learner.address.city`,
    ...
    },
    {
      ...
      title: "Sum Types",
      minutes: 11,
      summary: "Four necessary readings introduce sealed interfaces, variants, smart casts, and exhaustive case analysis. Optional readings compare sum and compound data, explain a common variant-field compiler error, and connect sum types to common program states.",
...
val supplies = CardPayment("4821")`,
    ...
    return if (payment is Payment.Cash) {
        ...
        R(
          ...
          "Sum Data versus Compound Data",
          "optional",
          "Compound data (sometimes called product data) carries every field together; sum data chooses one variant from several forms.",
          "Distinguish compound data from sum data in a problem statement.",
          ["sum-type", "data-class", "variant"],
          "A data class is often called <strong>compound data</strong>: constructing one value requires all its fields. A sealed family is sum data: constructing one value requires choosing one variant.",
          "The distinction guides design. Use compound data for facts that coexist at the same time. Use sum data for mutually-exclusive alternatives with different shapes.",
...
sealed interface Result {
    ...
    data class Failure(val reason: String): Result
          ...
          [
            Q("Is Coordinate compound or sum data?", "Compound data."),
            Q("Is Result compound or sum data?", "Sum data."),
...
val labels: List&lt;String&gt; = heights.map(::formatHeight)`,
        ...
        R(
          ...
          "These operations implement many summaries: totals, joined text, largest values, and custom compound results.",
